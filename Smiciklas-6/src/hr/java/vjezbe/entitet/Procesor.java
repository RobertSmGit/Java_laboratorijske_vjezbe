...
public class Procesor extends Komponenta implements Frekvencijska {
	 ...
	 */
	public Procesor(String naziv, String tip, BigDecimal brzina, String sucelje, BigDecimal cijena) {
		super(naziv, cijena);
		this.tip = tip;
		this.brzina = brzina;
	...
	public String getSucelje() {
		return sucelje;
	}


	public void setSucelje(String sucelje) {
		this.sucelje = sucelje;
	}
	...
	public String toString() {
		return " Procesor [tip=" + tip + ", brzina=" + brzina + ", suèelje procesora=" + sucelje + "]";
	}
